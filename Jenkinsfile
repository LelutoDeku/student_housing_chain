        ...
        stage('Push to ECR') {
            steps {
                script {
                    ...
                    sh '''
                        aws ecr get-login-password --region AWS_DEFAULT_REGION | docker login --username AWS --password-stdin 975050378366.dkr.ecr.us-east-1.amazonaws.com
                        ...
                        docker tag $DOCKER_IMAGE_NAME_FOR_SERVER ${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_DEFAULT_REGION}.amazonaws.com/${ECR_REPO_NAME}:server_3000
